...
🔹 **Observação:**
Aqui, **não precisamos** escrever `contagem = contagem + 1`, pois o **incremento é automático**.
...
var
    contagem: inteiro
inicio
    para contagem <- 0 até 3 passo 1 faça
        escreva("Contar ", contagem)
    fimpara
fimalgoritmo
```
...
Um **laço aninhado** ocorre quando um loop é executado **dentro de outro loop**.
